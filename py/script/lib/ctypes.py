...
# 加入模块
wintypes = __import__("wintypes")
util = __import__("ctypes_util")
_endian = __import__("_endian")
from _endian import BigEndianStructure, LittleEndianStructure
