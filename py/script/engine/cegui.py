...
Rect.__add__ = new_instancemethod(_cegui.Rect___add__,None,Rect)
...
Vector3.__eq__ = new_instancemethod(_cegui.Vector3___eq__,None,Vector3)
Vector3.__ne__ = new_instancemethod(_cegui.Vector3___ne__,None,Vector3)
Vector3.__mul__ = new_instancemethod(_cegui.Vector3___mul__,None,Vector3)
Vector3.__add__ = new_instancemethod(_cegui.Vector3___add__,None,Vector3)
...
Size.__mul__ = new_instancemethod(_cegui.Size___mul__,None,Size)
Size.__add__ = new_instancemethod(_cegui.Size___add__,None,Size)
...
class Imageset(object):
	...
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.Imageset_swiginit(self,_cegui.new_Imageset(*args))
...
Imageset.notifyDisplaySizeChanged = new_instancemethod(_cegui.Imageset_notifyDisplaySizeChanged,None,Imageset)
...
ColourRect.__mul__ = new_instancemethod(_cegui.ColourRect___mul__,None,ColourRect)
ColourRect.__add__ = new_instancemethod(_cegui.ColourRect___add__,None,ColourRect)
...
URect.__mul__ = new_instancemethod(_cegui.URect___mul__,None,URect)
URect.__add__ = new_instancemethod(_cegui.URect___add__,None,URect)
...
class UBox(object):
	...
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.UBox_swiginit(self,_cegui.new_UBox(*args))
	d_top = _swig_property(_cegui.UBox_d_top_get, _cegui.UBox_d_top_set)
	d_left = _swig_property(_cegui.UBox_d_left_get, _cegui.UBox_d_left_set)
	d_bottom = _swig_property(_cegui.UBox_d_bottom_get, _cegui.UBox_d_bottom_set)
	d_right = _swig_property(_cegui.UBox_d_right_get, _cegui.UBox_d_right_set)
	__swig_destroy__ = _cegui.delete_UBox
UBox.__eq__ = new_instancemethod(_cegui.UBox___eq__,None,UBox)
UBox.__ne__ = new_instancemethod(_cegui.UBox___ne__,None,UBox)
UBox.__mul__ = new_instancemethod(_cegui.UBox___mul__,None,UBox)
UBox.__add__ = new_instancemethod(_cegui.UBox___add__,None,UBox)
UBox_swigregister = _cegui.UBox_swigregister
UBox_swigregister(UBox)
...
class RenderTarget(object):
	...
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_RenderTarget
RenderTarget.draw = new_instancemethod(_cegui.RenderTarget_draw,None,RenderTarget)
RenderTarget.setArea = new_instancemethod(_cegui.RenderTarget_setArea,None,RenderTarget)
RenderTarget.getArea = new_instancemethod(_cegui.RenderTarget_getArea,None,RenderTarget)
RenderTarget.isImageryCache = new_instancemethod(_cegui.RenderTarget_isImageryCache,None,RenderTarget)
RenderTarget.activate = new_instancemethod(_cegui.RenderTarget_activate,None,RenderTarget)
RenderTarget.deactivate = new_instancemethod(_cegui.RenderTarget_deactivate,None,RenderTarget)
RenderTarget.unprojectPoint = new_instancemethod(_cegui.RenderTarget_unprojectPoint,None,RenderTarget)
RenderTarget_swigregister = _cegui.RenderTarget_swigregister
...
class TextureTarget(RenderTarget):
	...
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_TextureTarget
TextureTarget.clear = new_instancemethod(_cegui.TextureTarget_clear,None,TextureTarget)
TextureTarget.getTexture = new_instancemethod(_cegui.TextureTarget_getTexture,None,TextureTarget)
TextureTarget.declareRenderSize = new_instancemethod(_cegui.TextureTarget_declareRenderSize,None,TextureTarget)
TextureTarget.isRenderingInverted = new_instancemethod(_cegui.TextureTarget_isRenderingInverted,None,TextureTarget)
TextureTarget_swigregister = _cegui.TextureTarget_swigregister
TextureTarget_swigregister(TextureTarget)

TopLeftToBottomRight = _cegui.TopLeftToBottomRight
BottomLeftToTopRight = _cegui.BottomLeftToTopRight
BM_INVALID = _cegui.BM_INVALID
BM_NORMAL = _cegui.BM_NORMAL
BM_RTT_PREMULTIPLIED = _cegui.BM_RTT_PREMULTIPLIED
...
Renderer.getDefaultRenderingRoot = new_instancemethod(_cegui.Renderer_getDefaultRenderingRoot,None,Renderer)
Renderer.createGeometryBuffer = new_instancemethod(_cegui.Renderer_createGeometryBuffer,None,Renderer)
Renderer.destroyGeometryBuffer = new_instancemethod(_cegui.Renderer_destroyGeometryBuffer,None,Renderer)
Renderer.destroyAllGeometryBuffers = new_instancemethod(_cegui.Renderer_destroyAllGeometryBuffers,None,Renderer)
Renderer.createTextureTarget = new_instancemethod(_cegui.Renderer_createTextureTarget,None,Renderer)
Renderer.destroyTextureTarget = new_instancemethod(_cegui.Renderer_destroyTextureTarget,None,Renderer)
Renderer.destroyAllTextureTargets = new_instancemethod(_cegui.Renderer_destroyAllTextureTargets,None,Renderer)
...
Renderer.beginRendering = new_instancemethod(_cegui.Renderer_beginRendering,None,Renderer)
Renderer.endRendering = new_instancemethod(_cegui.Renderer_endRendering,None,Renderer)
Renderer.setDisplaySize = new_instancemethod(_cegui.Renderer_setDisplaySize,None,Renderer)
Renderer.getDisplaySize = new_instancemethod(_cegui.Renderer_getDisplaySize,None,Renderer)
Renderer.getDisplayDPI = new_instancemethod(_cegui.Renderer_getDisplayDPI,None,Renderer)
...
class GeometryBuffer(object):
	...
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_GeometryBuffer
GeometryBuffer.draw = new_instancemethod(_cegui.GeometryBuffer_draw,None,GeometryBuffer)
GeometryBuffer.setTranslation = new_instancemethod(_cegui.GeometryBuffer_setTranslation,None,GeometryBuffer)
GeometryBuffer.setRotation = new_instancemethod(_cegui.GeometryBuffer_setRotation,None,GeometryBuffer)
GeometryBuffer.setPivot = new_instancemethod(_cegui.GeometryBuffer_setPivot,None,GeometryBuffer)
GeometryBuffer.setClippingRegion = new_instancemethod(_cegui.GeometryBuffer_setClippingRegion,None,GeometryBuffer)
GeometryBuffer.appendVertex = new_instancemethod(_cegui.GeometryBuffer_appendVertex,None,GeometryBuffer)
GeometryBuffer.appendGeometry = new_instancemethod(_cegui.GeometryBuffer_appendGeometry,None,GeometryBuffer)
GeometryBuffer.setActiveTexture = new_instancemethod(_cegui.GeometryBuffer_setActiveTexture,None,GeometryBuffer)
GeometryBuffer.reset = new_instancemethod(_cegui.GeometryBuffer_reset,None,GeometryBuffer)
GeometryBuffer.getActiveTexture = new_instancemethod(_cegui.GeometryBuffer_getActiveTexture,None,GeometryBuffer)
GeometryBuffer.getVertexCount = new_instancemethod(_cegui.GeometryBuffer_getVertexCount,None,GeometryBuffer)
GeometryBuffer.getBatchCount = new_instancemethod(_cegui.GeometryBuffer_getBatchCount,None,GeometryBuffer)
GeometryBuffer.setRenderEffect = new_instancemethod(_cegui.GeometryBuffer_setRenderEffect,None,GeometryBuffer)
GeometryBuffer.getRenderEffect = new_instancemethod(_cegui.GeometryBuffer_getRenderEffect,None,GeometryBuffer)
GeometryBuffer.setBlendMode = new_instancemethod(_cegui.GeometryBuffer_setBlendMode,None,GeometryBuffer)
GeometryBuffer.getBlendMode = new_instancemethod(_cegui.GeometryBuffer_getBlendMode,None,GeometryBuffer)
GeometryBuffer.setSubImage = new_instancemethod(_cegui.GeometryBuffer_setSubImage,None,GeometryBuffer)
GeometryBuffer_swigregister = _cegui.GeometryBuffer_swigregister
GeometryBuffer_swigregister(GeometryBuffer)

RQ_USER_0 = _cegui.RQ_USER_0
RQ_UNDERLAY = _cegui.RQ_UNDERLAY
RQ_USER_1 = _cegui.RQ_USER_1
RQ_BASE = _cegui.RQ_BASE
RQ_USER_2 = _cegui.RQ_USER_2
RQ_CONTENT_1 = _cegui.RQ_CONTENT_1
RQ_USER_3 = _cegui.RQ_USER_3
RQ_CONTENT_2 = _cegui.RQ_CONTENT_2
RQ_USER_4 = _cegui.RQ_USER_4
RQ_OVERLAY = _cegui.RQ_OVERLAY
RQ_USER_5 = _cegui.RQ_USER_5
class RenderQueueEventArgs(EventArgs):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.RenderQueueEventArgs_swiginit(self,_cegui.new_RenderQueueEventArgs(*args))
	queueID = _swig_property(_cegui.RenderQueueEventArgs_queueID_get, _cegui.RenderQueueEventArgs_queueID_set)
	__swig_destroy__ = _cegui.delete_RenderQueueEventArgs
RenderQueueEventArgs_swigregister = _cegui.RenderQueueEventArgs_swigregister
RenderQueueEventArgs_swigregister(RenderQueueEventArgs)

class RenderingSurface(EventSet):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.RenderingSurface_swiginit(self,_cegui.new_RenderingSurface(*args))
	__swig_destroy__ = _cegui.delete_RenderingSurface
RenderingSurface.addGeometryBuffer = new_instancemethod(_cegui.RenderingSurface_addGeometryBuffer,None,RenderingSurface)
RenderingSurface.removeGeometryBuffer = new_instancemethod(_cegui.RenderingSurface_removeGeometryBuffer,None,RenderingSurface)
RenderingSurface.clearGeometry = new_instancemethod(_cegui.RenderingSurface_clearGeometry,None,RenderingSurface)
RenderingSurface.draw = new_instancemethod(_cegui.RenderingSurface_draw,None,RenderingSurface)
RenderingSurface.invalidate = new_instancemethod(_cegui.RenderingSurface_invalidate,None,RenderingSurface)
RenderingSurface.isInvalidated = new_instancemethod(_cegui.RenderingSurface_isInvalidated,None,RenderingSurface)
RenderingSurface.isRenderingWindow = new_instancemethod(_cegui.RenderingSurface_isRenderingWindow,None,RenderingSurface)
RenderingSurface.createRenderingWindow = new_instancemethod(_cegui.RenderingSurface_createRenderingWindow,None,RenderingSurface)
RenderingSurface.destroyRenderingWindow = new_instancemethod(_cegui.RenderingSurface_destroyRenderingWindow,None,RenderingSurface)
RenderingSurface.transferRenderingWindow = new_instancemethod(_cegui.RenderingSurface_transferRenderingWindow,None,RenderingSurface)
RenderingSurface.getRenderTarget = new_instancemethod(_cegui.RenderingSurface_getRenderTarget,None,RenderingSurface)
RenderingSurface_swigregister = _cegui.RenderingSurface_swigregister
RenderingSurface_swigregister(RenderingSurface)
RenderingSurface.EventNamespace = _cegui.cvar.RenderingSurface_EventNamespace
RenderingSurface.EventRenderQueueStarted = _cegui.cvar.RenderingSurface_EventRenderQueueStarted
RenderingSurface.EventRenderQueueEnded = _cegui.cvar.RenderingSurface_EventRenderQueueEnded

class RenderingRoot(RenderingSurface):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.RenderingRoot_swiginit(self,_cegui.new_RenderingRoot(*args))
	__swig_destroy__ = _cegui.delete_RenderingRoot
RenderingRoot_swigregister = _cegui.RenderingRoot_swigregister
RenderingRoot_swigregister(RenderingRoot)

class RenderingWindow(RenderingSurface):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.RenderingWindow_swiginit(self,_cegui.new_RenderingWindow(*args))
	__swig_destroy__ = _cegui.delete_RenderingWindow
RenderingWindow.setClippingRegion = new_instancemethod(_cegui.RenderingWindow_setClippingRegion,None,RenderingWindow)
RenderingWindow.setPosition = new_instancemethod(_cegui.RenderingWindow_setPosition,None,RenderingWindow)
RenderingWindow.setSize = new_instancemethod(_cegui.RenderingWindow_setSize,None,RenderingWindow)
RenderingWindow.setRotation = new_instancemethod(_cegui.RenderingWindow_setRotation,None,RenderingWindow)
RenderingWindow.setPivot = new_instancemethod(_cegui.RenderingWindow_setPivot,None,RenderingWindow)
RenderingWindow.getPosition = new_instancemethod(_cegui.RenderingWindow_getPosition,None,RenderingWindow)
RenderingWindow.getSize = new_instancemethod(_cegui.RenderingWindow_getSize,None,RenderingWindow)
RenderingWindow.getRotation = new_instancemethod(_cegui.RenderingWindow_getRotation,None,RenderingWindow)
RenderingWindow.getPivot = new_instancemethod(_cegui.RenderingWindow_getPivot,None,RenderingWindow)
RenderingWindow.getTextureTarget = new_instancemethod(_cegui.RenderingWindow_getTextureTarget,None,RenderingWindow)
RenderingWindow.update = new_instancemethod(_cegui.RenderingWindow_update,None,RenderingWindow)
RenderingWindow.setRenderEffect = new_instancemethod(_cegui.RenderingWindow_setRenderEffect,None,RenderingWindow)
RenderingWindow.getRenderEffect = new_instancemethod(_cegui.RenderingWindow_getRenderEffect,None,RenderingWindow)
RenderingWindow.realiseGeometry = new_instancemethod(_cegui.RenderingWindow_realiseGeometry,None,RenderingWindow)
RenderingWindow.invalidateGeometry = new_instancemethod(_cegui.RenderingWindow_invalidateGeometry,None,RenderingWindow)
RenderingWindow.getOwner = new_instancemethod(_cegui.RenderingWindow_getOwner,None,RenderingWindow)
RenderingWindow.unprojectPoint = new_instancemethod(_cegui.RenderingWindow_unprojectPoint,None,RenderingWindow)
RenderingWindow_swigregister = _cegui.RenderingWindow_swigregister
RenderingWindow_swigregister(RenderingWindow)
...
ResourceProvider.getResourceGroupFileNames = new_instancemethod(_cegui.ResourceProvider_getResourceGroupFileNames,None,ResourceProvider)
...
class Font(PropertySet):
	...
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_Font
...
Font.getName = new_instancemethod(_cegui.Font_getName,None,Font)
Font.getTypeName = new_instancemethod(_cegui.Font_getTypeName,None,Font)
...
Font.getNativeResolution = new_instancemethod(_cegui.Font_getNativeResolution,None,Font)
Font.setAutoScaled = new_instancemethod(_cegui.Font_setAutoScaled,None,Font)
Font.isAutoScaled = new_instancemethod(_cegui.Font_isAutoScaled,None,Font)
Font.notifyDisplaySizeChanged = new_instancemethod(_cegui.Font_notifyDisplaySizeChanged,None,Font)
...
Font.writeXMLToStream = new_instancemethod(_cegui.Font_writeXMLToStream,None,Font)
Font.getGlyphData = new_instancemethod(_cegui.Font_getGlyphData,None,Font)
...
Font.isCaratInTag = new_instancemethod(_cegui.Font_isCaratInTag,None,Font)
Font.getHyperlinkTextArea = new_instancemethod(_cegui.Font_getHyperlinkTextArea,None,Font)
Font.getTag = new_instancemethod(_cegui.Font_getTag,None,Font)
Font.isMultiDeleteTag = new_instancemethod(_cegui.Font_isMultiDeleteTag,None,Font)
...
def Font_setDefaultResourceGroup(*args):
  return _cegui.Font_setDefaultResourceGroup(*args)
Font_setDefaultResourceGroup = _cegui.Font_setDefaultResourceGroup

def Font_getDefaultResourceGroup():
  return _cegui.Font_getDefaultResourceGroup()
Font_getDefaultResourceGroup = _cegui.Font_getDefaultResourceGroup

class HyperlinkTag(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	m_tagBeginPos = _swig_property(_cegui.HyperlinkTag_m_tagBeginPos_get, _cegui.HyperlinkTag_m_tagBeginPos_set)
	m_tagEndPos = _swig_property(_cegui.HyperlinkTag_m_tagEndPos_get, _cegui.HyperlinkTag_m_tagEndPos_set)
	m_tag_str = _swig_property(_cegui.HyperlinkTag_m_tag_str_get, _cegui.HyperlinkTag_m_tag_str_set)
	def __init__(self, *args): 
		_cegui.HyperlinkTag_swiginit(self,_cegui.new_HyperlinkTag(*args))
	__swig_destroy__ = _cegui.delete_HyperlinkTag
HyperlinkTag_swigregister = _cegui.HyperlinkTag_swigregister
HyperlinkTag_swigregister(HyperlinkTag)
...
ListboxItem.getTextVisual = new_instancemethod(_cegui.ListboxItem_getTextVisual,None,ListboxItem)
...
class ListboxTextItem(ListboxItem):
	...
	TextParsingEnabled = property(_cegui.ListboxTextItem_TextParsingEnabled_get, _cegui.ListboxTextItem_TextParsingEnabled_set, None,
					"ListboxTextItem.TextParsingEnabled -> bool\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: bool ListboxTextItem::isTextParsingEnabled()\n\tset: void ListboxTextItem::setTextParsingEnabled(bool)")
...
class TreeItem(object):
	...
	Font = property(_cegui.TreeItem___getFont, fix_args(_cegui.TreeItem___setFont), None,
					"TreeItem.Font -> type\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: TreeItem::getFont()\n\tset: void TreeItem::setFont(...)")
	...
	ItemCount = property(_cegui.TreeItem_ItemCount_get, None, None,
					"TreeItem.ItemCount -> size_t  (read-only)\n\nThis is equivalent to calling the C++ CEGUI method:\n\tget: size_t TreeItem::getItemCount()")
	...
	ParentItem = property(_cegui.TreeItem_ParentItem_get, None, None,
					"TreeItem.ParentItem -> const CEGUI::TreeItem *  (read-only)\n\nThis is equivalent to calling the C++ CEGUI method:\n\tget: const CEGUI::TreeItem * TreeItem::getParentItem()")

TreeItem.getTextVisual = new_instancemethod(_cegui.TreeItem_getTextVisual,None,TreeItem)
...
WUM_ALWAYS = _cegui.WUM_ALWAYS
WUM_NEVER = _cegui.WUM_NEVER
WUM_VISIBLE = _cegui.WUM_VISIBLE
...
Window.getTextVisual = new_instancemethod(_cegui.Window_getTextVisual,None,Window)
Window.getUnclippedRect = new_instancemethod(_cegui.Window_getUnclippedRect,None,Window)
Window.getClipRect = new_instancemethod(_cegui.Window_getClipRect,None,Window)
Window.getHitTestRect = new_instancemethod(_cegui.Window_getHitTestRect,None,Window)
Window.getChildWindowContentArea = new_instancemethod(_cegui.Window_getChildWindowContentArea,None,Window)
...
Window.getGeometryBuffer = new_instancemethod(_cegui.Window_getGeometryBuffer,None,Window)
...
Window.getRenderingContext = new_instancemethod(_cegui.Window_getRenderingContext,None,Window)
Window.getRenderingContext_impl = new_instancemethod(_cegui.Window_getRenderingContext_impl,None,Window)
Window.getRenderingSurface = new_instancemethod(_cegui.Window_getRenderingSurface,None,Window)
Window.getTargetRenderingSurface = new_instancemethod(_cegui.Window_getTargetRenderingSurface,None,Window)
Window.isUsingAutoRenderingSurface = new_instancemethod(_cegui.Window_isUsingAutoRenderingSurface,None,Window)
Window.getRootWindow = new_instancemethod(_cegui.Window_getRootWindow,None,Window)
Window.getRotation = new_instancemethod(_cegui.Window_getRotation,None,Window)
Window.isNonClientWindow = new_instancemethod(_cegui.Window_isNonClientWindow,None,Window)
...
Window.moveInFront = new_instancemethod(_cegui.Window_moveInFront,None,Window)
Window.moveBehind = new_instancemethod(_cegui.Window_moveBehind,None,Window)
...
Window.invalidate = new_instancemethod(_cegui.Window_invalidate,None,Window)
...
Window.setRenderingSurface = new_instancemethod(_cegui.Window_setRenderingSurface,None,Window)
Window.invalidateRenderingSurface = new_instancemethod(_cegui.Window_invalidateRenderingSurface,None,Window)
Window.setUsingAutoRenderingSurface = new_instancemethod(_cegui.Window_setUsingAutoRenderingSurface,None,Window)
Window.setRotation = new_instancemethod(_cegui.Window_setRotation,None,Window)
Window.setNonClientWindow = new_instancemethod(_cegui.Window_setNonClientWindow,None,Window)
Window.getRenderedString = new_instancemethod(_cegui.Window_getRenderedString,None,Window)
Window.getCustomRenderedStringParser = new_instancemethod(_cegui.Window_getCustomRenderedStringParser,None,Window)
Window.setCustomRenderedStringParser = new_instancemethod(_cegui.Window_setCustomRenderedStringParser,None,Window)
Window.getRenderedStringParser = new_instancemethod(_cegui.Window_getRenderedStringParser,None,Window)
Window.isTextParsingEnabled = new_instancemethod(_cegui.Window_isTextParsingEnabled,None,Window)
Window.setTextParsingEnabled = new_instancemethod(_cegui.Window_setTextParsingEnabled,None,Window)
Window.setMargin = new_instancemethod(_cegui.Window_setMargin,None,Window)
Window.getMargin = new_instancemethod(_cegui.Window_getMargin,None,Window)
Window.getUnprojectedPosition = new_instancemethod(_cegui.Window_getUnprojectedPosition,None,Window)
Window.getBiDiVisualMapping = new_instancemethod(_cegui.Window_getBiDiVisualMapping,None,Window)
Window.banPropertyFromXML = new_instancemethod(_cegui.Window_banPropertyFromXML,None,Window)
Window.unbanPropertyFromXML = new_instancemethod(_cegui.Window_unbanPropertyFromXML,None,Window)
Window.isPropertyBannedFromXML = new_instancemethod(_cegui.Window_isPropertyBannedFromXML,None,Window)
Window.setUpdateMode = new_instancemethod(_cegui.Window_setUpdateMode,None,Window)
Window.getUpdateMode = new_instancemethod(_cegui.Window_getUpdateMode,None,Window)
Window.setMouseInputPropagationEnabled = new_instancemethod(_cegui.Window_setMouseInputPropagationEnabled,None,Window)
Window.isMouseInputPropagationEnabled = new_instancemethod(_cegui.Window_isMouseInputPropagationEnabled,None,Window)
Window.clone = new_instancemethod(_cegui.Window_clone,None,Window)
Window.clonePropertiesTo = new_instancemethod(_cegui.Window_clonePropertiesTo,None,Window)
Window.cloneChildWidgetsTo = new_instancemethod(_cegui.Window_cloneChildWidgetsTo,None,Window)
Window.setFigure = new_instancemethod(_cegui.Window_setFigure,None,Window)
Window.isPerformChildWindowLayoutEnabled = new_instancemethod(_cegui.Window_isPerformChildWindowLayoutEnabled,None,Window)
Window.setAlwaysInputFocus = new_instancemethod(_cegui.Window_setAlwaysInputFocus,None,Window)
Window.isAlwaysInputFocus = new_instancemethod(_cegui.Window_isAlwaysInputFocus,None,Window)
...
Window.EventRotated = _cegui.cvar.Window_EventRotated
Window.EventNonClientChanged = _cegui.cvar.Window_EventNonClientChanged
Window.EventTextParsingChanged = _cegui.cvar.Window_EventTextParsingChanged
Window.EventMarginChanged = _cegui.cvar.Window_EventMarginChanged
Window.EventMouseEntersArea = _cegui.cvar.Window_EventMouseEntersArea
Window.EventMouseLeavesArea = _cegui.cvar.Window_EventMouseLeavesArea
...
WindowRenderer.getRenderingContext = new_instancemethod(_cegui.WindowRenderer_getRenderingContext,None,WindowRenderer)
WindowRenderer.update = new_instancemethod(_cegui.WindowRenderer_update,None,WindowRenderer)
...
class DragContainer(Window):
	...
	StickyModeEnabled = property(_cegui.DragContainer_StickyModeEnabled_get, _cegui.DragContainer_StickyModeEnabled_set, None,
					"DragContainer.StickyModeEnabled -> bool\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: bool DragContainer::isStickyModeEnabled()\n\tset: void DragContainer::setStickyModeEnabled(bool)")


	FixedDragOffset = property(_cegui.DragContainer_FixedDragOffset_get, _cegui.DragContainer_FixedDragOffset_set, None,
					"DragContainer.FixedDragOffset -> CEGUI::UVector2&\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: CEGUI::UVector2& DragContainer::getFixedDragOffset()\n\tset: void DragContainer::setFixedDragOffset(CEGUI::UVector2&)")


	UsingFixedDragOffset = property(_cegui.DragContainer_UsingFixedDragOffset_get, _cegui.DragContainer_UsingFixedDragOffset_set, None,
					"DragContainer.UsingFixedDragOffset -> bool\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: bool DragContainer::isUsingFixedDragOffset()\n\tset: void DragContainer::setUsingFixedDragOffset(bool)")


DragContainer.pickUp = new_instancemethod(_cegui.DragContainer_pickUp,None,DragContainer)
...
Combobox.isHit = new_instancemethod(_cegui.Combobox_isHit,None,Combobox)
...
FrameWindow.EventDragSizingStarted = _cegui.cvar.FrameWindow_EventDragSizingStarted
FrameWindow.EventDragSizingEnded = _cegui.cvar.FrameWindow_EventDragSizingEnded
...
Listbox.getItemAtPoint = new_instancemethod(_cegui.Listbox_getItemAtPoint,None,Listbox)
...
class MultiLineEditbox(Window):
	...
	ShowVertScrollbar = property(_cegui.MultiLineEditbox_ShowVertScrollbar_get, _cegui.MultiLineEditbox_ShowVertScrollbar_set, None,
					"MultiLineEditbox.ShowVertScrollbar -> bool\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: bool MultiLineEditbox::isVertScrollbarAlwaysShown()\n\tset: void MultiLineEditbox::setShowVertScrollbar(bool)")


	SelectionBrushImage = property(_cegui.MultiLineEditbox_SelectionBrushImage_get, _cegui.MultiLineEditbox_SelectionBrushImage_set, None,
					"MultiLineEditbox.SelectionBrushImage -> CEGUI::Image*\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: CEGUI::Image* MultiLineEditbox::getSelectionBrushImage()\n\tset: void MultiLineEditbox::setSelectionBrushImage(CEGUI::Image*)")
...
class Scrollbar(Window):
	...
	EndLockEnabled = property(_cegui.Scrollbar_EndLockEnabled_get, _cegui.Scrollbar_EndLockEnabled_set, None,
					"Scrollbar.EndLockEnabled -> bool\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: bool Scrollbar::isEndLockEnabled()\n\tset: void Scrollbar::setEndLockEnabled(bool)")
...
Scrollbar.setConfig = new_instancemethod(_cegui.Scrollbar_setConfig,None,Scrollbar)
...
ScrolledItemListBase.ensureItemIsVisibleVert = new_instancemethod(_cegui.ScrolledItemListBase_ensureItemIsVisibleVert,None,ScrolledItemListBase)
ScrolledItemListBase.ensureItemIsVisibleHorz = new_instancemethod(_cegui.ScrolledItemListBase_ensureItemIsVisibleHorz,None,ScrolledItemListBase)
...
class ItemListbox(ScrolledItemListBase):
	...
	SelectedCount = property(_cegui.ItemListbox_SelectedCount_get, _cegui.ItemListbox_SelectedCount_set, None,
					"ItemListbox.SelectedCount -> bool\n\nThis is equivalent to calling the C++ CEGUI methods:\n\tget: bool ItemListbox::isMultiSelectEnabled()\n\tset: void ItemListbox::setMultiSelectEnabled(bool)")
...
class GroupBox(Window):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.GroupBox_swiginit(self,_cegui.new_GroupBox(*args))
	__swig_destroy__ = _cegui.delete_GroupBox
GroupBox.drawAroundWidget = new_instancemethod(_cegui.GroupBox_drawAroundWidget,None,GroupBox)
GroupBox.testClassName_impl = new_instancemethod(_cegui.GroupBox_testClassName_impl,None,GroupBox)
GroupBox.getContentPane = new_instancemethod(_cegui.GroupBox_getContentPane,None,GroupBox)
GroupBox_swigregister = _cegui.GroupBox_swigregister
GroupBox_swigregister(GroupBox)
GroupBox.WidgetTypeName = _cegui.cvar.GroupBox_WidgetTypeName
GroupBox.ContentPaneNameSuffix = _cegui.cvar.GroupBox_ContentPaneNameSuffix

class LayoutContainer(Window):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_LayoutContainer
LayoutContainer.markNeedsLayouting = new_instancemethod(_cegui.LayoutContainer_markNeedsLayouting,None,LayoutContainer)
LayoutContainer.needsLayouting = new_instancemethod(_cegui.LayoutContainer_needsLayouting,None,LayoutContainer)
LayoutContainer.layout = new_instancemethod(_cegui.LayoutContainer_layout,None,LayoutContainer)
LayoutContainer.layoutIfNecessary = new_instancemethod(_cegui.LayoutContainer_layoutIfNecessary,None,LayoutContainer)
LayoutContainer_swigregister = _cegui.LayoutContainer_swigregister
LayoutContainer_swigregister(LayoutContainer)

class GridLayoutContainer(LayoutContainer):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	AP_Disabled = _cegui.GridLayoutContainer_AP_Disabled
	AP_LeftToRight = _cegui.GridLayoutContainer_AP_LeftToRight
	AP_TopToBottom = _cegui.GridLayoutContainer_AP_TopToBottom
	def __init__(self, *args): 
		_cegui.GridLayoutContainer_swiginit(self,_cegui.new_GridLayoutContainer(*args))
	__swig_destroy__ = _cegui.delete_GridLayoutContainer
GridLayoutContainer.setGridDimensions = new_instancemethod(_cegui.GridLayoutContainer_setGridDimensions,None,GridLayoutContainer)
GridLayoutContainer.getGridWidth = new_instancemethod(_cegui.GridLayoutContainer_getGridWidth,None,GridLayoutContainer)
GridLayoutContainer.getGridHeight = new_instancemethod(_cegui.GridLayoutContainer_getGridHeight,None,GridLayoutContainer)
GridLayoutContainer.setAutoPositioning = new_instancemethod(_cegui.GridLayoutContainer_setAutoPositioning,None,GridLayoutContainer)
GridLayoutContainer.getAutoPositioning = new_instancemethod(_cegui.GridLayoutContainer_getAutoPositioning,None,GridLayoutContainer)
GridLayoutContainer.setNextAutoPositioningIdx = new_instancemethod(_cegui.GridLayoutContainer_setNextAutoPositioningIdx,None,GridLayoutContainer)
GridLayoutContainer.getNextAutoPositioningIdx = new_instancemethod(_cegui.GridLayoutContainer_getNextAutoPositioningIdx,None,GridLayoutContainer)
GridLayoutContainer.autoPositioningSkipCells = new_instancemethod(_cegui.GridLayoutContainer_autoPositioningSkipCells,None,GridLayoutContainer)
GridLayoutContainer.addChildWindowToPosition = new_instancemethod(_cegui.GridLayoutContainer_addChildWindowToPosition,None,GridLayoutContainer)
GridLayoutContainer.getChildWindowAtPosition = new_instancemethod(_cegui.GridLayoutContainer_getChildWindowAtPosition,None,GridLayoutContainer)
GridLayoutContainer.removeChildWindowFromPosition = new_instancemethod(_cegui.GridLayoutContainer_removeChildWindowFromPosition,None,GridLayoutContainer)
GridLayoutContainer.swapChildWindowPositions = new_instancemethod(_cegui.GridLayoutContainer_swapChildWindowPositions,None,GridLayoutContainer)
GridLayoutContainer.swapChildWindows = new_instancemethod(_cegui.GridLayoutContainer_swapChildWindows,None,GridLayoutContainer)
GridLayoutContainer.moveChildWindowToPosition = new_instancemethod(_cegui.GridLayoutContainer_moveChildWindowToPosition,None,GridLayoutContainer)
GridLayoutContainer_swigregister = _cegui.GridLayoutContainer_swigregister
GridLayoutContainer_swigregister(GridLayoutContainer)
GridLayoutContainer.WidgetTypeName = _cegui.cvar.GridLayoutContainer_WidgetTypeName
GridLayoutContainer.DummyNameSuffix = _cegui.cvar.GridLayoutContainer_DummyNameSuffix
GridLayoutContainer.EventChildWindowOrderChanged = _cegui.cvar.GridLayoutContainer_EventChildWindowOrderChanged

class SequentialLayoutContainer(LayoutContainer):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_SequentialLayoutContainer
SequentialLayoutContainer.getPositionOfChildWindow = new_instancemethod(_cegui.SequentialLayoutContainer_getPositionOfChildWindow,None,SequentialLayoutContainer)
SequentialLayoutContainer.getChildWindowAtPosition = new_instancemethod(_cegui.SequentialLayoutContainer_getChildWindowAtPosition,None,SequentialLayoutContainer)
SequentialLayoutContainer.swapChildWindowPositions = new_instancemethod(_cegui.SequentialLayoutContainer_swapChildWindowPositions,None,SequentialLayoutContainer)
SequentialLayoutContainer.swapChildWindows = new_instancemethod(_cegui.SequentialLayoutContainer_swapChildWindows,None,SequentialLayoutContainer)
SequentialLayoutContainer.moveChildWindowToPosition = new_instancemethod(_cegui.SequentialLayoutContainer_moveChildWindowToPosition,None,SequentialLayoutContainer)
SequentialLayoutContainer.moveChildWindow = new_instancemethod(_cegui.SequentialLayoutContainer_moveChildWindow,None,SequentialLayoutContainer)
SequentialLayoutContainer.addChildWindowToPosition = new_instancemethod(_cegui.SequentialLayoutContainer_addChildWindowToPosition,None,SequentialLayoutContainer)
SequentialLayoutContainer.removeChildWindowFromPosition = new_instancemethod(_cegui.SequentialLayoutContainer_removeChildWindowFromPosition,None,SequentialLayoutContainer)
SequentialLayoutContainer_swigregister = _cegui.SequentialLayoutContainer_swigregister
SequentialLayoutContainer_swigregister(SequentialLayoutContainer)
SequentialLayoutContainer.EventChildWindowOrderChanged = _cegui.cvar.SequentialLayoutContainer_EventChildWindowOrderChanged

class HorizontalLayoutContainer(SequentialLayoutContainer):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.HorizontalLayoutContainer_swiginit(self,_cegui.new_HorizontalLayoutContainer(*args))
	__swig_destroy__ = _cegui.delete_HorizontalLayoutContainer
HorizontalLayoutContainer_swigregister = _cegui.HorizontalLayoutContainer_swigregister
HorizontalLayoutContainer_swigregister(HorizontalLayoutContainer)
HorizontalLayoutContainer.WidgetTypeName = _cegui.cvar.HorizontalLayoutContainer_WidgetTypeName

class VerticalLayoutContainer(SequentialLayoutContainer):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.VerticalLayoutContainer_swiginit(self,_cegui.new_VerticalLayoutContainer(*args))
	__swig_destroy__ = _cegui.delete_VerticalLayoutContainer
VerticalLayoutContainer_swigregister = _cegui.VerticalLayoutContainer_swigregister
VerticalLayoutContainer_swigregister(VerticalLayoutContainer)
VerticalLayoutContainer.WidgetTypeName = _cegui.cvar.VerticalLayoutContainer_WidgetTypeName
...
class DisplayEventArgs(EventArgs):
	...
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.DisplayEventArgs_swiginit(self,_cegui.new_DisplayEventArgs(*args))
	size = _swig_property(_cegui.DisplayEventArgs_size_get, _cegui.DisplayEventArgs_size_set)
	__swig_destroy__ = _cegui.delete_DisplayEventArgs
DisplayEventArgs_swigregister = _cegui.DisplayEventArgs_swigregister
DisplayEventArgs_swigregister(DisplayEventArgs)

class ResourceEventArgs(EventArgs):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.ResourceEventArgs_swiginit(self,_cegui.new_ResourceEventArgs(*args))
	resourceType = _swig_property(_cegui.ResourceEventArgs_resourceType_get, _cegui.ResourceEventArgs_resourceType_set)
	resourceName = _swig_property(_cegui.ResourceEventArgs_resourceName_get, _cegui.ResourceEventArgs_resourceName_set)
	__swig_destroy__ = _cegui.delete_ResourceEventArgs
ResourceEventArgs_swigregister = _cegui.ResourceEventArgs_swigregister
ResourceEventArgs_swigregister(ResourceEventArgs)
...
Tree.getTreeItemFromIndex = new_instancemethod(_cegui.Tree_getTreeItemFromIndex,None,Tree)
Tree_swigregister = _cegui.Tree_swigregister
Tree_swigregister(Tree)
Tree.WidgetTypeName = _cegui.cvar.Tree_WidgetTypeName

XREA_RETURN = _cegui.XREA_RETURN
XREA_REPLACE = _cegui.XREA_REPLACE
XREA_THROW = _cegui.XREA_THROW
class ResourceEventSet(EventSet):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
		_cegui.ResourceEventSet_swiginit(self,_cegui.new_ResourceEventSet())
	__swig_destroy__ = _cegui.delete_ResourceEventSet
ResourceEventSet_swigregister = _cegui.ResourceEventSet_swigregister
ResourceEventSet_swigregister(ResourceEventSet)
ResourceEventSet.EventNamespace = _cegui.cvar.ResourceEventSet_EventNamespace
ResourceEventSet.EventResourceCreated = _cegui.cvar.ResourceEventSet_EventResourceCreated
ResourceEventSet.EventResourceDestroyed = _cegui.cvar.ResourceEventSet_EventResourceDestroyed
ResourceEventSet.EventResourceReplaced = _cegui.cvar.ResourceEventSet_EventResourceReplaced
...
class _FontManagerNamedXMLResourceManager(ResourceEventSet):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui._FontManagerNamedXMLResourceManager_swiginit(self,_cegui.new__FontManagerNamedXMLResourceManager(*args))
	__swig_destroy__ = _cegui.delete__FontManagerNamedXMLResourceManager
_FontManagerNamedXMLResourceManager.create = new_instancemethod(_cegui._FontManagerNamedXMLResourceManager_create,None,_FontManagerNamedXMLResourceManager)
_FontManagerNamedXMLResourceManager.destroy = new_instancemethod(_cegui._FontManagerNamedXMLResourceManager_destroy,None,_FontManagerNamedXMLResourceManager)
_FontManagerNamedXMLResourceManager.destroyAll = new_instancemethod(_cegui._FontManagerNamedXMLResourceManager_destroyAll,None,_FontManagerNamedXMLResourceManager)
_FontManagerNamedXMLResourceManager.get = new_instancemethod(_cegui._FontManagerNamedXMLResourceManager_get,None,_FontManagerNamedXMLResourceManager)
_FontManagerNamedXMLResourceManager.isDefined = new_instancemethod(_cegui._FontManagerNamedXMLResourceManager_isDefined,None,_FontManagerNamedXMLResourceManager)
_FontManagerNamedXMLResourceManager.createAll = new_instancemethod(_cegui._FontManagerNamedXMLResourceManager_createAll,None,_FontManagerNamedXMLResourceManager)
_FontManagerNamedXMLResourceManager_swigregister = _cegui._FontManagerNamedXMLResourceManager_swigregister
_FontManagerNamedXMLResourceManager_swigregister(_FontManagerNamedXMLResourceManager)

class FontManager(_FontManagerSingleton,_FontManagerNamedXMLResourceManager):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
		_cegui.FontManager_swiginit(self,_cegui.new_FontManager())
	__swig_destroy__ = _cegui.delete_FontManager
FontManager.createFreeTypeFont = new_instancemethod(_cegui.FontManager_createFreeTypeFont,None,FontManager)
FontManager.createPixmapFont = new_instancemethod(_cegui.FontManager_createPixmapFont,None,FontManager)
FontManager.notifyDisplaySizeChanged = new_instancemethod(_cegui.FontManager_notifyDisplaySizeChanged,None,FontManager)
FontManager.writeFontToStream = new_instancemethod(_cegui.FontManager_writeFontToStream,None,FontManager)
FontManager.create = new_instancemethod(_cegui.FontManager_create,None,FontManager)
...
class _ImagesetManagerNamedXMLResourceManager(ResourceEventSet):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui._ImagesetManagerNamedXMLResourceManager_swiginit(self,_cegui.new__ImagesetManagerNamedXMLResourceManager(*args))
	__swig_destroy__ = _cegui.delete__ImagesetManagerNamedXMLResourceManager
_ImagesetManagerNamedXMLResourceManager.create = new_instancemethod(_cegui._ImagesetManagerNamedXMLResourceManager_create,None,_ImagesetManagerNamedXMLResourceManager)
_ImagesetManagerNamedXMLResourceManager.destroy = new_instancemethod(_cegui._ImagesetManagerNamedXMLResourceManager_destroy,None,_ImagesetManagerNamedXMLResourceManager)
_ImagesetManagerNamedXMLResourceManager.destroyAll = new_instancemethod(_cegui._ImagesetManagerNamedXMLResourceManager_destroyAll,None,_ImagesetManagerNamedXMLResourceManager)
_ImagesetManagerNamedXMLResourceManager.get = new_instancemethod(_cegui._ImagesetManagerNamedXMLResourceManager_get,None,_ImagesetManagerNamedXMLResourceManager)
_ImagesetManagerNamedXMLResourceManager.isDefined = new_instancemethod(_cegui._ImagesetManagerNamedXMLResourceManager_isDefined,None,_ImagesetManagerNamedXMLResourceManager)
_ImagesetManagerNamedXMLResourceManager.createAll = new_instancemethod(_cegui._ImagesetManagerNamedXMLResourceManager_createAll,None,_ImagesetManagerNamedXMLResourceManager)
_ImagesetManagerNamedXMLResourceManager_swigregister = _cegui._ImagesetManagerNamedXMLResourceManager_swigregister
_ImagesetManagerNamedXMLResourceManager_swigregister(_ImagesetManagerNamedXMLResourceManager)

class ImagesetManager(_ImagesetManagerSingleton,_ImagesetManagerNamedXMLResourceManager):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
		_cegui.ImagesetManager_swiginit(self,_cegui.new_ImagesetManager())
	__swig_destroy__ = _cegui.delete_ImagesetManager
ImagesetManager.createFromImageFile = new_instancemethod(_cegui.ImagesetManager_createFromImageFile,None,ImagesetManager)
ImagesetManager.notifyDisplaySizeChanged = new_instancemethod(_cegui.ImagesetManager_notifyDisplaySizeChanged,None,ImagesetManager)
...
ImagesetManager.create = new_instancemethod(_cegui.ImagesetManager_create,None,ImagesetManager)
...
class MouseCursor(EventSet,_MouseCursorSingleton):
	...
	setInitialMousePosition = staticmethod(_cegui.MouseCursor_setInitialMousePosition)
...
MouseCursor.notifyDisplaySizeChanged = new_instancemethod(_cegui.MouseCursor_notifyDisplaySizeChanged,None,MouseCursor)
MouseCursor.setExplicitRenderSize = new_instancemethod(_cegui.MouseCursor_setExplicitRenderSize,None,MouseCursor)
MouseCursor.getExplicitRenderSize = new_instancemethod(_cegui.MouseCursor_getExplicitRenderSize,None,MouseCursor)
MouseCursor.invalidate = new_instancemethod(_cegui.MouseCursor_invalidate,None,MouseCursor)
...
def MouseCursor_setInitialMousePosition(*args):
  return _cegui.MouseCursor_setInitialMousePosition(*args)
MouseCursor_setInitialMousePosition = _cegui.MouseCursor_setInitialMousePosition
...
class _SchemeManagerNamedXMLResourceManager(ResourceEventSet):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui._SchemeManagerNamedXMLResourceManager_swiginit(self,_cegui.new__SchemeManagerNamedXMLResourceManager(*args))
	__swig_destroy__ = _cegui.delete__SchemeManagerNamedXMLResourceManager
_SchemeManagerNamedXMLResourceManager.create = new_instancemethod(_cegui._SchemeManagerNamedXMLResourceManager_create,None,_SchemeManagerNamedXMLResourceManager)
_SchemeManagerNamedXMLResourceManager.destroy = new_instancemethod(_cegui._SchemeManagerNamedXMLResourceManager_destroy,None,_SchemeManagerNamedXMLResourceManager)
_SchemeManagerNamedXMLResourceManager.destroyAll = new_instancemethod(_cegui._SchemeManagerNamedXMLResourceManager_destroyAll,None,_SchemeManagerNamedXMLResourceManager)
_SchemeManagerNamedXMLResourceManager.get = new_instancemethod(_cegui._SchemeManagerNamedXMLResourceManager_get,None,_SchemeManagerNamedXMLResourceManager)
_SchemeManagerNamedXMLResourceManager.isDefined = new_instancemethod(_cegui._SchemeManagerNamedXMLResourceManager_isDefined,None,_SchemeManagerNamedXMLResourceManager)
_SchemeManagerNamedXMLResourceManager.createAll = new_instancemethod(_cegui._SchemeManagerNamedXMLResourceManager_createAll,None,_SchemeManagerNamedXMLResourceManager)
_SchemeManagerNamedXMLResourceManager_swigregister = _cegui._SchemeManagerNamedXMLResourceManager_swigregister
_SchemeManagerNamedXMLResourceManager_swigregister(_SchemeManagerNamedXMLResourceManager)

class SchemeManager(_SchemeManagerSingleton,_SchemeManagerNamedXMLResourceManager):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
...
class WindowManager(_WindowManagerSingleton,EventSet):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
...
WindowManager.saveWindowLayout = new_instancemethod(_cegui.WindowManager_saveWindowLayout,None,WindowManager)
WindowManager.renameWindow = new_instancemethod(_cegui.WindowManager_renameWindow,None,WindowManager)
WindowManager.lock = new_instancemethod(_cegui.WindowManager_lock,None,WindowManager)
WindowManager.unlock = new_instancemethod(_cegui.WindowManager_unlock,None,WindowManager)
WindowManager.isLocked = new_instancemethod(_cegui.WindowManager_isLocked,None,WindowManager)
...
WindowManager.EventNamespace = _cegui.cvar.WindowManager_EventNamespace
WindowManager.EventWindowCreated = _cegui.cvar.WindowManager_EventWindowCreated
WindowManager.EventWindowDestroyed = _cegui.cvar.WindowManager_EventWindowDestroyed
...
class System(_SystemSingleton,EventSet):
	...
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	create = staticmethod(_cegui.System_create)
	destroy = staticmethod(_cegui.System_destroy)
	...
	setDefaultImageCodecName = staticmethod(_cegui.System_setDefaultImageCodecName)
	getDefaultImageCodecName = staticmethod(_cegui.System_getDefaultImageCodecName)
...
System.isMouseClickEventGenerationEnabled = new_instancemethod(_cegui.System_isMouseClickEventGenerationEnabled,None,System)
System.setMouseClickEventGenerationEnabled = new_instancemethod(_cegui.System_setMouseClickEventGenerationEnabled,None,System)
...
System.getImageCodec = new_instancemethod(_cegui.System_getImageCodec,None,System)
System.setImageCodec = new_instancemethod(_cegui.System_setImageCodec,None,System)
System.notifyDisplaySizeChanged = new_instancemethod(_cegui.System_notifyDisplaySizeChanged,None,System)
System.getDefaultCustomRenderedStringParser = new_instancemethod(_cegui.System_getDefaultCustomRenderedStringParser,None,System)
System.setDefaultCustomRenderedStringParser = new_instancemethod(_cegui.System_setDefaultCustomRenderedStringParser,None,System)
System.invalidateAllCachedRendering = new_instancemethod(_cegui.System_invalidateAllCachedRendering,None,System)
...
System.injectMouseButtonClick = new_instancemethod(_cegui.System_injectMouseButtonClick,None,System)
System.injectMouseButtonDoubleClick = new_instancemethod(_cegui.System_injectMouseButtonDoubleClick,None,System)
System.injectMouseButtonTripleClick = new_instancemethod(_cegui.System_injectMouseButtonTripleClick,None,System)
...
System.EventDisplaySizeChanged = _cegui.cvar.System_EventDisplaySizeChanged
System.EventRenderedStringParserChanged = _cegui.cvar.System_EventRenderedStringParserChanged

def System_create(*args):
  return _cegui.System_create(*args)
System_create = _cegui.System_create

def System_destroy():
  return _cegui.System_destroy()
System_destroy = _cegui.System_destroy
...
def System_setDefaultImageCodecName(*args):
  return _cegui.System_setDefaultImageCodecName(*args)
System_setDefaultImageCodecName = _cegui.System_setDefaultImageCodecName

def System_getDefaultImageCodecName():
  return _cegui.System_getDefaultImageCodecName()
System_getDefaultImageCodecName = _cegui.System_getDefaultImageCodecName
...
class KeyFrame(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	P_Linear = _cegui.KeyFrame_P_Linear
	P_QuadraticAccelerating = _cegui.KeyFrame_P_QuadraticAccelerating
	P_QuadraticDecelerating = _cegui.KeyFrame_P_QuadraticDecelerating
	P_Discrete = _cegui.KeyFrame_P_Discrete
	def __init__(self, *args): 
		_cegui.KeyFrame_swiginit(self,_cegui.new_KeyFrame(*args))
	__swig_destroy__ = _cegui.delete_KeyFrame
KeyFrame.getParent = new_instancemethod(_cegui.KeyFrame_getParent,None,KeyFrame)
KeyFrame.moveToPosition = new_instancemethod(_cegui.KeyFrame_moveToPosition,None,KeyFrame)
KeyFrame.getPosition = new_instancemethod(_cegui.KeyFrame_getPosition,None,KeyFrame)
KeyFrame.setValue = new_instancemethod(_cegui.KeyFrame_setValue,None,KeyFrame)
KeyFrame.getValue = new_instancemethod(_cegui.KeyFrame_getValue,None,KeyFrame)
KeyFrame.setSourceProperty = new_instancemethod(_cegui.KeyFrame_setSourceProperty,None,KeyFrame)
KeyFrame.getSourceProperty = new_instancemethod(_cegui.KeyFrame_getSourceProperty,None,KeyFrame)
KeyFrame.getValueForAnimation = new_instancemethod(_cegui.KeyFrame_getValueForAnimation,None,KeyFrame)
KeyFrame.setProgression = new_instancemethod(_cegui.KeyFrame_setProgression,None,KeyFrame)
KeyFrame.getProgression = new_instancemethod(_cegui.KeyFrame_getProgression,None,KeyFrame)
KeyFrame.alterInterpolationPosition = new_instancemethod(_cegui.KeyFrame_alterInterpolationPosition,None,KeyFrame)
KeyFrame.savePropertyValue = new_instancemethod(_cegui.KeyFrame_savePropertyValue,None,KeyFrame)
KeyFrame.notifyPositionChanged = new_instancemethod(_cegui.KeyFrame_notifyPositionChanged,None,KeyFrame)
KeyFrame_swigregister = _cegui.KeyFrame_swigregister
KeyFrame_swigregister(KeyFrame)

class Affector(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	AM_Absolute = _cegui.Affector_AM_Absolute
	AM_Relative = _cegui.Affector_AM_Relative
	AM_RelativeMultiply = _cegui.Affector_AM_RelativeMultiply
	def __init__(self, *args): 
		_cegui.Affector_swiginit(self,_cegui.new_Affector(*args))
	__swig_destroy__ = _cegui.delete_Affector
Affector.setApplicationMethod = new_instancemethod(_cegui.Affector_setApplicationMethod,None,Affector)
Affector.getApplicationMethod = new_instancemethod(_cegui.Affector_getApplicationMethod,None,Affector)
Affector.setTargetProperty = new_instancemethod(_cegui.Affector_setTargetProperty,None,Affector)
Affector.getTargetProperty = new_instancemethod(_cegui.Affector_getTargetProperty,None,Affector)
Affector.setInterpolator = new_instancemethod(_cegui.Affector_setInterpolator,None,Affector)
Affector.getInterpolator = new_instancemethod(_cegui.Affector_getInterpolator,None,Affector)
Affector.createKeyFrame = new_instancemethod(_cegui.Affector_createKeyFrame,None,Affector)
Affector.destroyKeyFrame = new_instancemethod(_cegui.Affector_destroyKeyFrame,None,Affector)
Affector.getKeyFrameAtPosition = new_instancemethod(_cegui.Affector_getKeyFrameAtPosition,None,Affector)
Affector.getKeyFrameAtIdx = new_instancemethod(_cegui.Affector_getKeyFrameAtIdx,None,Affector)
Affector.getNumKeyFrames = new_instancemethod(_cegui.Affector_getNumKeyFrames,None,Affector)
Affector.moveKeyFrameToPosition = new_instancemethod(_cegui.Affector_moveKeyFrameToPosition,None,Affector)
Affector.savePropertyValues = new_instancemethod(_cegui.Affector_savePropertyValues,None,Affector)
Affector.apply = new_instancemethod(_cegui.Affector_apply,None,Affector)
Affector_swigregister = _cegui.Affector_swigregister
Affector_swigregister(Affector)

class AnimationEventArgs(EventArgs):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.AnimationEventArgs_swiginit(self,_cegui.new_AnimationEventArgs(*args))
	instance = _swig_property(_cegui.AnimationEventArgs_instance_get, _cegui.AnimationEventArgs_instance_set)
	__swig_destroy__ = _cegui.delete_AnimationEventArgs
AnimationEventArgs_swigregister = _cegui.AnimationEventArgs_swigregister
AnimationEventArgs_swigregister(AnimationEventArgs)

class AnimationInstance(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self, *args): 
		_cegui.AnimationInstance_swiginit(self,_cegui.new_AnimationInstance(*args))
	__swig_destroy__ = _cegui.delete_AnimationInstance
AnimationInstance.getDefinition = new_instancemethod(_cegui.AnimationInstance_getDefinition,None,AnimationInstance)
AnimationInstance.setTarget = new_instancemethod(_cegui.AnimationInstance_setTarget,None,AnimationInstance)
AnimationInstance.getTarget = new_instancemethod(_cegui.AnimationInstance_getTarget,None,AnimationInstance)
AnimationInstance.setEventReceiver = new_instancemethod(_cegui.AnimationInstance_setEventReceiver,None,AnimationInstance)
AnimationInstance.getEventReceiver = new_instancemethod(_cegui.AnimationInstance_getEventReceiver,None,AnimationInstance)
AnimationInstance.setEventSender = new_instancemethod(_cegui.AnimationInstance_setEventSender,None,AnimationInstance)
AnimationInstance.getEventSender = new_instancemethod(_cegui.AnimationInstance_getEventSender,None,AnimationInstance)
AnimationInstance.setTargetWindow = new_instancemethod(_cegui.AnimationInstance_setTargetWindow,None,AnimationInstance)
AnimationInstance.setPosition = new_instancemethod(_cegui.AnimationInstance_setPosition,None,AnimationInstance)
AnimationInstance.getPosition = new_instancemethod(_cegui.AnimationInstance_getPosition,None,AnimationInstance)
AnimationInstance.setSpeed = new_instancemethod(_cegui.AnimationInstance_setSpeed,None,AnimationInstance)
AnimationInstance.getSpeed = new_instancemethod(_cegui.AnimationInstance_getSpeed,None,AnimationInstance)
AnimationInstance.setSkipNextStep = new_instancemethod(_cegui.AnimationInstance_setSkipNextStep,None,AnimationInstance)
AnimationInstance.getSkipNextStep = new_instancemethod(_cegui.AnimationInstance_getSkipNextStep,None,AnimationInstance)
AnimationInstance.setMaxStepDeltaSkip = new_instancemethod(_cegui.AnimationInstance_setMaxStepDeltaSkip,None,AnimationInstance)
AnimationInstance.getMaxStepDeltaSkip = new_instancemethod(_cegui.AnimationInstance_getMaxStepDeltaSkip,None,AnimationInstance)
AnimationInstance.setMaxStepDeltaClamp = new_instancemethod(_cegui.AnimationInstance_setMaxStepDeltaClamp,None,AnimationInstance)
AnimationInstance.getMaxStepDeltaClamp = new_instancemethod(_cegui.AnimationInstance_getMaxStepDeltaClamp,None,AnimationInstance)
AnimationInstance.start = new_instancemethod(_cegui.AnimationInstance_start,None,AnimationInstance)
AnimationInstance.stop = new_instancemethod(_cegui.AnimationInstance_stop,None,AnimationInstance)
AnimationInstance.pause = new_instancemethod(_cegui.AnimationInstance_pause,None,AnimationInstance)
AnimationInstance.unpause = new_instancemethod(_cegui.AnimationInstance_unpause,None,AnimationInstance)
AnimationInstance.togglePause = new_instancemethod(_cegui.AnimationInstance_togglePause,None,AnimationInstance)
AnimationInstance.isRunning = new_instancemethod(_cegui.AnimationInstance_isRunning,None,AnimationInstance)
AnimationInstance.step = new_instancemethod(_cegui.AnimationInstance_step,None,AnimationInstance)
AnimationInstance.handleStart = new_instancemethod(_cegui.AnimationInstance_handleStart,None,AnimationInstance)
AnimationInstance.handleStop = new_instancemethod(_cegui.AnimationInstance_handleStop,None,AnimationInstance)
AnimationInstance.handlePause = new_instancemethod(_cegui.AnimationInstance_handlePause,None,AnimationInstance)
AnimationInstance.handleUnpause = new_instancemethod(_cegui.AnimationInstance_handleUnpause,None,AnimationInstance)
AnimationInstance.handleTogglePause = new_instancemethod(_cegui.AnimationInstance_handleTogglePause,None,AnimationInstance)
AnimationInstance.savePropertyValue = new_instancemethod(_cegui.AnimationInstance_savePropertyValue,None,AnimationInstance)
AnimationInstance.purgeSavedPropertyValues = new_instancemethod(_cegui.AnimationInstance_purgeSavedPropertyValues,None,AnimationInstance)
AnimationInstance.getSavedPropertyValue = new_instancemethod(_cegui.AnimationInstance_getSavedPropertyValue,None,AnimationInstance)
AnimationInstance.addAutoConnection = new_instancemethod(_cegui.AnimationInstance_addAutoConnection,None,AnimationInstance)
AnimationInstance.unsubscribeAutoConnections = new_instancemethod(_cegui.AnimationInstance_unsubscribeAutoConnections,None,AnimationInstance)
AnimationInstance_swigregister = _cegui.AnimationInstance_swigregister
AnimationInstance_swigregister(AnimationInstance)
AnimationInstance.EventNamespace = _cegui.cvar.AnimationInstance_EventNamespace
AnimationInstance.EventAnimationStarted = _cegui.cvar.AnimationInstance_EventAnimationStarted
AnimationInstance.EventAnimationStopped = _cegui.cvar.AnimationInstance_EventAnimationStopped
AnimationInstance.EventAnimationPaused = _cegui.cvar.AnimationInstance_EventAnimationPaused
AnimationInstance.EventAnimationUnpaused = _cegui.cvar.AnimationInstance_EventAnimationUnpaused
AnimationInstance.EventAnimationEnded = _cegui.cvar.AnimationInstance_EventAnimationEnded
AnimationInstance.EventAnimationLooped = _cegui.cvar.AnimationInstance_EventAnimationLooped

class Animation(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	RM_Once = _cegui.Animation_RM_Once
	RM_Loop = _cegui.Animation_RM_Loop
	RM_Bounce = _cegui.Animation_RM_Bounce
	def __init__(self, *args): 
		_cegui.Animation_swiginit(self,_cegui.new_Animation(*args))
	__swig_destroy__ = _cegui.delete_Animation
Animation.getName = new_instancemethod(_cegui.Animation_getName,None,Animation)
Animation.setReplayMode = new_instancemethod(_cegui.Animation_setReplayMode,None,Animation)
Animation.getReplayMode = new_instancemethod(_cegui.Animation_getReplayMode,None,Animation)
Animation.setDuration = new_instancemethod(_cegui.Animation_setDuration,None,Animation)
Animation.getDuration = new_instancemethod(_cegui.Animation_getDuration,None,Animation)
Animation.setAutoStart = new_instancemethod(_cegui.Animation_setAutoStart,None,Animation)
Animation.getAutoStart = new_instancemethod(_cegui.Animation_getAutoStart,None,Animation)
Animation.createAffector = new_instancemethod(_cegui.Animation_createAffector,None,Animation)
Animation.destroyAffector = new_instancemethod(_cegui.Animation_destroyAffector,None,Animation)
Animation.getAffectorAtIdx = new_instancemethod(_cegui.Animation_getAffectorAtIdx,None,Animation)
Animation.getNumAffectors = new_instancemethod(_cegui.Animation_getNumAffectors,None,Animation)
Animation.defineAutoSubscription = new_instancemethod(_cegui.Animation_defineAutoSubscription,None,Animation)
Animation.undefineAutoSubscription = new_instancemethod(_cegui.Animation_undefineAutoSubscription,None,Animation)
Animation.undefineAllAutoSubscriptions = new_instancemethod(_cegui.Animation_undefineAllAutoSubscriptions,None,Animation)
Animation.autoSubscribe = new_instancemethod(_cegui.Animation_autoSubscribe,None,Animation)
Animation.autoUnsubscribe = new_instancemethod(_cegui.Animation_autoUnsubscribe,None,Animation)
Animation.savePropertyValues = new_instancemethod(_cegui.Animation_savePropertyValues,None,Animation)
Animation.apply = new_instancemethod(_cegui.Animation_apply,None,Animation)
Animation_swigregister = _cegui.Animation_swigregister
Animation_swigregister(Animation)

class _AnimationManagerSingleton(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
		_cegui._AnimationManagerSingleton_swiginit(self,_cegui.new__AnimationManagerSingleton())
	__swig_destroy__ = _cegui.delete__AnimationManagerSingleton
	getSingleton = staticmethod(_cegui._AnimationManagerSingleton_getSingleton)
_AnimationManagerSingleton_swigregister = _cegui._AnimationManagerSingleton_swigregister
_AnimationManagerSingleton_swigregister(_AnimationManagerSingleton)

def _AnimationManagerSingleton_getSingleton():
  return _cegui._AnimationManagerSingleton_getSingleton()
_AnimationManagerSingleton_getSingleton = _cegui._AnimationManagerSingleton_getSingleton

class AnimationManager(_AnimationManagerSingleton):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	__repr__ = _swig_repr
	def __init__(self): 
		_cegui.AnimationManager_swiginit(self,_cegui.new_AnimationManager())
	__swig_destroy__ = _cegui.delete_AnimationManager
	setDefaultResourceGroup = staticmethod(_cegui.AnimationManager_setDefaultResourceGroup)
	getDefaultResourceGroup = staticmethod(_cegui.AnimationManager_getDefaultResourceGroup)
AnimationManager.addInterpolator = new_instancemethod(_cegui.AnimationManager_addInterpolator,None,AnimationManager)
AnimationManager.removeInterpolator = new_instancemethod(_cegui.AnimationManager_removeInterpolator,None,AnimationManager)
AnimationManager.getInterpolator = new_instancemethod(_cegui.AnimationManager_getInterpolator,None,AnimationManager)
AnimationManager.createAnimation = new_instancemethod(_cegui.AnimationManager_createAnimation,None,AnimationManager)
AnimationManager.destroyAnimation = new_instancemethod(_cegui.AnimationManager_destroyAnimation,None,AnimationManager)
AnimationManager.getAnimation = new_instancemethod(_cegui.AnimationManager_getAnimation,None,AnimationManager)
AnimationManager.getAnimationAtIdx = new_instancemethod(_cegui.AnimationManager_getAnimationAtIdx,None,AnimationManager)
AnimationManager.getNumAnimations = new_instancemethod(_cegui.AnimationManager_getNumAnimations,None,AnimationManager)
AnimationManager.instantiateAnimation = new_instancemethod(_cegui.AnimationManager_instantiateAnimation,None,AnimationManager)
AnimationManager.destroyAnimationInstance = new_instancemethod(_cegui.AnimationManager_destroyAnimationInstance,None,AnimationManager)
AnimationManager.destroyAllInstancesOfAnimation = new_instancemethod(_cegui.AnimationManager_destroyAllInstancesOfAnimation,None,AnimationManager)
AnimationManager.getAnimationInstanceAtIdx = new_instancemethod(_cegui.AnimationManager_getAnimationInstanceAtIdx,None,AnimationManager)
AnimationManager.getNumAnimationInstances = new_instancemethod(_cegui.AnimationManager_getNumAnimationInstances,None,AnimationManager)
AnimationManager.stepInstances = new_instancemethod(_cegui.AnimationManager_stepInstances,None,AnimationManager)
AnimationManager.loadAnimationsFromXML = new_instancemethod(_cegui.AnimationManager_loadAnimationsFromXML,None,AnimationManager)
AnimationManager_swigregister = _cegui.AnimationManager_swigregister
AnimationManager_swigregister(AnimationManager)

def AnimationManager_setDefaultResourceGroup(*args):
  return _cegui.AnimationManager_setDefaultResourceGroup(*args)
AnimationManager_setDefaultResourceGroup = _cegui.AnimationManager_setDefaultResourceGroup

def AnimationManager_getDefaultResourceGroup():
  return _cegui.AnimationManager_getDefaultResourceGroup()
AnimationManager_getDefaultResourceGroup = _cegui.AnimationManager_getDefaultResourceGroup

class Interpolator(object):
	thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
	def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
	__repr__ = _swig_repr
	__swig_destroy__ = _cegui.delete_Interpolator
Interpolator.getType = new_instancemethod(_cegui.Interpolator_getType,None,Interpolator)
Interpolator.interpolateAbsolute = new_instancemethod(_cegui.Interpolator_interpolateAbsolute,None,Interpolator)
Interpolator.interpolateRelative = new_instancemethod(_cegui.Interpolator_interpolateRelative,None,Interpolator)
Interpolator.interpolateRelativeMultiply = new_instancemethod(_cegui.Interpolator_interpolateRelativeMultiply,None,Interpolator)
Interpolator_swigregister = _cegui.Interpolator_swigregister
...
class PropertyHelper(object):
	...
	stringToVector3 = staticmethod(_cegui.PropertyHelper_stringToVector3)
	...
	stringToUBox = staticmethod(_cegui.PropertyHelper_stringToUBox)
	...
	vector3ToString = staticmethod(_cegui.PropertyHelper_vector3ToString)
	...
	uboxToString = staticmethod(_cegui.PropertyHelper_uboxToString)
	def __init__(self): 
...
def PropertyHelper_stringToVector3(*args):
  return _cegui.PropertyHelper_stringToVector3(*args)
PropertyHelper_stringToVector3 = _cegui.PropertyHelper_stringToVector3
...
def PropertyHelper_stringToUBox(*args):
  return _cegui.PropertyHelper_stringToUBox(*args)
PropertyHelper_stringToUBox = _cegui.PropertyHelper_stringToUBox
...
def PropertyHelper_vector3ToString(*args):
  return _cegui.PropertyHelper_vector3ToString(*args)
PropertyHelper_vector3ToString = _cegui.PropertyHelper_vector3ToString
...
def PropertyHelper_uboxToString(*args):
  return _cegui.PropertyHelper_uboxToString(*args)
PropertyHelper_uboxToString = _cegui.PropertyHelper_uboxToString
