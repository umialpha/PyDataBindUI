...
#line 1 "E:/splendorTrunk/Resource/Shaders/ForwardPassFX.hlsl"
#line 13 "E:/splendorTrunk/Resource/Shaders/ForwardPassFX.hlsl"
...
#line 47 "ConstantDescription.hlsl"
...
float FarPlane;
float InvFarPlane;
#line 64 "ConstantDescription.hlsl"
...
#line 65 "ConstantDescription.hlsl"
#line 94 "Common.hlsl"
...
{
	float2  Local0 = (VectorUniformExpressions[0].rg + Parameters.TexCoords[0].xy);
	float2  Local1 = (Local0 * VectorUniformExpressions[1].rg);
	float4  Local2 = ProcessMaterialColorTextureLookup(Texture2DSample(Tex0,Tex0Sampler,Local1));
	float  Local3 = dot(Parameters.WorldNormal, Parameters.CameraVector);
	float  Local4 = max(0.00000000,Local3);
	float  Local5 = (1.00000000 - Local4);
	float  Local6 = ClampedPow(Local5,ScalarUniformExpressions.x);
	float  Local7 = (Local6 * 1.00000000 );
	float  Local8 = (Local7 + 0.00000000);
	float3  Local9 = (Local2.rgb * Local8);
	float3  Local10 = (Local9 * VectorUniformExpressions[2].rgb);
	float3  Local11 = (Local10 * ScalarUniformExpressions.y);
	return Local11;
}
...
#line 60 "LocalVertexFactory.hlsl"
};
#line 67 "LocalVertexFactory.hlsl"
...
#line 82 "LocalVertexFactory.hlsl"
struct VertexFactoryOutput
{
	float4 TangentToWorld0 : TEXCOORD10 ; float4 TangentToWorld2 : TEXCOORD11 ;
#line 91 "LocalVertexFactory.hlsl"
	float2 TexCoords[ 1 ] : TEXCOORD0;
#line 101 "LocalVertexFactory.hlsl"
};
...
#line 118 "LocalVertexFactory.hlsl"
	locals.TangentToWorld = CalcTangentToWorld( locals.TangentToLocal );
	return locals;
}
#line 127 "LocalVertexFactory.hlsl"
...
#line 175 "LocalVertexFactory.hlsl"
...
#line 206 "LocalVertexFactory.hlsl"
	return Output;
}
...
#line 231 "LocalVertexFactory.hlsl"
...
#line 239 "LocalVertexFactory.hlsl"
...
#line 14 "E:/splendorTrunk/Resource/Shaders/ForwardPassFX.hlsl"
...
#line 19 "ForwardPassPS.hlsl"
#line 1 "ShadowCommon.hlsl"
#line 8 "ShadowCommon.hlsl"
#line 1 "Common.hlsl"
#line 9 "Common.hlsl"
#line 1 "Definitions.hlsl"
#line 10 "Common.hlsl"
#line 9 "ShadowCommon.hlsl"
#line 21 "ShadowCommon.hlsl"
...
#line 48 "ForwardPassPS.hlsl"
	...
	half3 Color = 0;
#line 196 "ForwardPassPS.hlsl"
	half Opacity = GetOpacity(Parameters);
	half3 Emissive = GetEmissive( Parameters );
	Color += Emissive;
#line 206 "ForwardPassPS.hlsl"
		Color = sqrt( Color );
#line 224 "ForwardPassPS.hlsl"
	OutColor = half4( Color, 1 );

}
#line 15 "E:/splendorTrunk/Resource/Shaders/ForwardPassFX.hlsl"
technique TShader
{
	pass Pass1
	{
